<!-- Modal actividad-->
<div class="modal fade" id="lista_actividad_modal" tabindex="-1" role="dialog" aria-labelledby="lista_actividad_modal_label">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          <h4 class="modal-title" id="lista_actividad_modal_label">Titulo temp</h4>
        </div>
